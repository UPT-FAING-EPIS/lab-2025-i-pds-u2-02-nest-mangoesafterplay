...
/**
 * Pruebas unitarias para validar el proceso manual de registro de un cliente.
 * Se testean los pasos por separado: validación, guardado y notificación.
 */
...
/**
 * Prueba unitaria que valida el proceso completo de registro
 * utilizando la clase CustomerRegistration (Fachada).
 */
